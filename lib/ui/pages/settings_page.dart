  import 'dart:io';
  import 'package:echocall/services/sim_service.dart';
import 'package:flutter/material.dart';
  ...
  class _SettingsPageState extends State<SettingsPage> {
    ...
    //   }
    //
    //   if (!await MobileNumber.hasPhonePermission) return;
    //
    //   try {
    ...
    Widget build(BuildContext context) {
      ...
      // final availableSims = activeSimCards.asMap().entries.map((entry) {
      //   final index = entry.key;
      //
      //   final sim = entry.value;
      //   final number=sim.number;
      //   final label = sim.displayName?.isNotEmpty == true ? sim.displayName! : sim.carrierName ?? 'SIM ${index + 1}';
      //   return '$label [$number]';
      // }).toList();
